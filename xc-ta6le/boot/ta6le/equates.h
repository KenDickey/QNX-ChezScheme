...
#define reloc_x86_64_popcount 0x3
...
#define tc_guardian_entries_disp 0x120
#define tc_handler_stack_disp 0x170
...
#define tc_pb_call_arena_disp 0x2F8
#define tc_pb_fpregs_disp 0x2F8
#define tc_pb_regs_disp 0x2F8
#define tc_random_seed_disp 0x138
#define tc_real_eap_disp 0x90
#define tc_ret_disp 0x60
#define tc_save1_disp 0x98
#define tc_scheme_stack_disp 0x140
#define tc_scheme_stack_size_disp 0x158
...
#define tc_stack_cache_disp 0x148
#define tc_stack_link_disp 0x150
...
#define tc_virtual_registers_disp 0xA0
#define tc_winders_disp 0x160
...
#define AC0(x) (*((xptr *)TO_VOIDP((uptr)(x)+40)))
#define AC1(x) (*((xptr *)TO_VOIDP((uptr)(x)+48)))
#define ACTIVE(x) (*((I32 *)TO_VOIDP((uptr)(x)+316)))
#define ALLOCCOUNTER(x) (*((U64 *)TO_VOIDP((uptr)(x)+664)))
#define AP(x) (*((xptr *)TO_VOIDP((uptr)(x)+80)))
#define ARGREGS(x,i) (((xptr *)TO_VOIDP((uptr)(x)+0))[i])
#define ATTACHMENTS(x) (*((ptr *)TO_VOIDP((uptr)(x)+360)))
#define BLOCKCOUNTER(x) (*((ptr *)TO_VOIDP((uptr)(x)+504)))
#define CACHEDFRAME(x) (*((ptr *)TO_VOIDP((uptr)(x)+376)))
#define CCHAIN(x) (*((ptr *)TO_VOIDP((uptr)(x)+296)))
#define CODERANGESTOFLUSH(x) (*((ptr *)TO_VOIDP((uptr)(x)+304)))
...
#define CP(x) (*((xptr *)TO_VOIDP((uptr)(x)+64)))
...
#define EAP(x) (*((xptr *)TO_VOIDP((uptr)(x)+88)))
#define ESP(x) (*((xptr *)TO_VOIDP((uptr)(x)+72)))
...
#define GUARDIANENTRIES(x) (*((ptr *)TO_VOIDP((uptr)(x)+288)))
#define HANDLERSTACK(x) (*((ptr *)TO_VOIDP((uptr)(x)+368)))
...
#define PBCALLARENA(x,i) (((uptr *)TO_VOIDP((uptr)(x)+760))[i])
#define PBFPREGS(x,i) (((double *)TO_VOIDP((uptr)(x)+760))[i])
#define PBREGS(x,i) (((uptr *)TO_VOIDP((uptr)(x)+760))[i])
#define RANDOMSEED(x) (*((U32 *)TO_VOIDP((uptr)(x)+312)))
#define REAL_EAP(x) (*((xptr *)TO_VOIDP((uptr)(x)+144)))
#define RET(x) (*((xptr *)TO_VOIDP((uptr)(x)+96)))
#define SAVE1(x) (*((xptr *)TO_VOIDP((uptr)(x)+152)))
#define SCHEMESTACK(x) (*((xptr *)TO_VOIDP((uptr)(x)+320)))
#define SCHEMESTACKSIZE(x) (*((iptr *)TO_VOIDP((uptr)(x)+344)))
#define SFD(x) (*((ptr *)TO_VOIDP((uptr)(x)+512)))
#define SFP(x) (*((xptr *)TO_VOIDP((uptr)(x)+56)))
...
#define STACKCACHE(x) (*((ptr *)TO_VOIDP((uptr)(x)+328)))
#define STACKLINK(x) (*((ptr *)TO_VOIDP((uptr)(x)+336)))
...
#define TD(x) (*((xptr *)TO_VOIDP((uptr)(x)+136)))
#define THREADNO(x) (*((ptr *)TO_VOIDP((uptr)(x)+472)))
#define TIMERTICKS(x) (*((ptr *)TO_VOIDP((uptr)(x)+432)))
#define TRAP(x) (*((xptr *)TO_VOIDP((uptr)(x)+104)))
#define TS(x) (*((xptr *)TO_VOIDP((uptr)(x)+128)))
#define VIRTUALREGISTERS(x,i) (((ptr *)TO_VOIDP((uptr)(x)+160))[i])
#define WINDERS(x) (*((ptr *)TO_VOIDP((uptr)(x)+352)))
#define XP(x) (*((xptr *)TO_VOIDP((uptr)(x)+112)))
#define YP(x) (*((xptr *)TO_VOIDP((uptr)(x)+120)))
#define ARGREG(x,i) (((xptr *)TO_VOIDP((uptr)(x)+0))[i])
#define VIRTREG(x,i) (((ptr *)TO_VOIDP((uptr)(x)+160))[i])
